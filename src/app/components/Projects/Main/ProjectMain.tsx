        ...
        <AnimatePresence>
          {expanded === null && showBoxes && (
            <motion.div
              ...
              className="flex flex-col flex-wrap items-center justify-center gap-y-10 rounded-lg px-10 py-10"
            >
              {boxes.map((_, idx) => (
                <div
                  key={idx}
                  onClick={() => setExpanded(idx)}
                  className="flex h-70 w-[920px] cursor-pointer flex-col text-center transition"
                >
                  {idx == 0 && (
                    <motion.div
                      whileHover={{
                      ...
                      className="group/project-0 flex h-full w-120 items-end justify-center bg-[url('@/assets/Projects/LoRaSmartFarm/thumbnail.png')] bg-cover bg-center bg-blend-soft-light hover:bg-gray-800"
                      style={{
                  ...
                  {idx == 1 && (
                    <motion.div
                      ...
                      className="group/project-1 flex h-full w-120 items-end justify-center bg-[url('@/assets/Projects/FPGAHand/Xilinx.png')] bg-cover bg-center bg-blend-soft-light hover:bg-gray-900"
                    >
                  ...
                  {idx == 2 && (
                    <motion.div
                      ...
                      className="group/project-2 flex h-full w-120 items-end justify-center bg-[url('@/assets/Projects/Fingerprint/fingerprintThumbnail.png')] bg-cover bg-center bg-blend-soft-light hover:bg-gray-800"
                    >
                  ...
                  {idx == 3 && (
                    <motion.div
                      ...
                      className="group/project-3 flex h-full w-120 items-end justify-center bg-[url('@/assets/Projects/Boids/BoidsThumbNail.png')] bg-cover bg-center bg-blend-soft-light hover:bg-gray-800"
                    >
