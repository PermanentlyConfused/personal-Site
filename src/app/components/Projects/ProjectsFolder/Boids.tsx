      ...
      <div className="flex flex-col lg:flex-row lg:justify-center">
        <div className="flex flex-col lg:w-[60%] lg:px-4">
          ...
          <p className="text-semibold text-base">
            ...
            Minecraft we know today. Instead of giving up, I started several
            small projects that will(hopefully) teach me enough to eventually
            allow me to build minecraft from scratch one day. The goal of this
            project was for me to learn how to use perlin noise to create a
            world and visualize it on a 2D plane. However, having a world
