...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="flex flex-row flex-wrap items-center justify-center gap-6 pb-20 lg:grid lg:grid-cols-2 lg:grid-rows-3 lg:gap-x-10 lg:gap-y-5 lg:py-15 lg:pt-10">
      <a
        href="/about"
